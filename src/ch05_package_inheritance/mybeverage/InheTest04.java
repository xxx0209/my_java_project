...
//        latte.enjoyLatte();
        ...
        for (int i = 0; i < beverage.length; i++) {
            ...
            if(beverage[i] instanceof Americano04) {
                Americano04 americano04 = (Americano04)beverage[i];
                americano04.sipAmericano();
            } else if (beverage[i] instanceof Espresso04) {
                Espresso04 espresso04 = (Espresso04)beverage[i];
                espresso04.drinkEspresso();
            } else if (beverage[i] instanceof Latte04) {
                Latte04 latte04 = (Latte04)beverage[i];
                latte04.enjoyLatte();
            } else {
